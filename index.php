...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) == "edit") {
        ...
        $simpan = mysqli_query($koneksi, " INSERT INTO tbarang (kode, nama, nama_penerima, asal, jumlah, satuan, tanggal_diterima)
                                            VALUE ( '$_POST[tkode]',
                                                    '$_POST[tnama]',                                         
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    if (isset($_POST['bcari'])) {
                        ...
                        $keyword = $_POST['tcari'];
                        $q = "SELECT * FROM tbarang WHERE kode like '%$keyword%' or nama like  '%$keyword%' or nama_penerima like '%$keyword%' or asal like '%$keyword%' order by id_barang desc  ";
                    } else {
